...
import cv2
import numpy as np
#opencv contrib, rasspery pi camera sdk
def main():
    # Define the IP address and port to send data to
    ip_address = "192.168.0.127"  # Replace with the IP address of the receiver
    ...
    # stream the new capture     


    # Loop to continuously capture frames and send them over the socket connection
    while True:
